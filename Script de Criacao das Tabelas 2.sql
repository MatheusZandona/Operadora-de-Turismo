CREATE DATABASE IF NOT EXISTS OPTRANSPORTE;
...
CREATE TABLE HOTEL_QUARTOS (
  ...
  INDEX HOTEL_QUARTOS_FKIndex2(QUARTOS_ID),
  FOREIGN KEY(HOTEL_ID)
    REFERENCES HOTEL(ID)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
...
CREATE TABLE SERVICOS_PACOTES (
  ...
  INDEX SERVICOS_PACOTES_FKIndex3(PREST_SERVICO_SERVICOS_PREST_SERVICO_ID, PREST_SERVICO_SERVICOS_SERVICOS_ID),
